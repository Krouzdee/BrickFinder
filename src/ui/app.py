...
class Window(ctk.CTk):
    def __init__(self):
        ...
        self.add_preview_label = None
        self.add_preview_frame = None
        self.detail_name_entry = None
    ...
    @staticmethod
    def load_file():
        filename = filedialog.askopenfilename(filetypes=[("Image/Video files", "*.jpg *.jpeg *.png *.bmp *.mp4 *.avi")])
        if filename:
            pass
